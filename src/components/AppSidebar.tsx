import { Anchor, Ship, Users, QrCode, Settings, LogOut, LayoutDashboard, MessageSquare, Receipt, Star, Bot, Wine } from 'lucide-react';
...
export function AppSidebar() {
  ...
  const ownerItems = [
    ...
    { title: 'Drinks Menu', url: '/menu', icon: Wine },
